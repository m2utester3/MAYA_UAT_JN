...
not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.ImageView0'), 0)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.TextView0 - Profile'), 0)
...
Mobile.setText(findTestObject('Maya/spy1/upd/android.widget.EditText0 - Test'), 'ch', 0)
...
Mobile.setText(findTestObject('Maya/spy1/upd/android.widget.EditText0 - Test'), 'Test', 0)

driver.pressKeyCode(AndroidKeyCode.ENTER)

Mobile.tap(findTestObject('Maya/spy1/upd/android.widget.TextView0 - 6013 XXXX 565'), 0)
...
Mobile.tapAtPosition(821.5, 1750.3)
...
Mobile.tapAtPosition(986.7, 195)
...
not_run: Mobile.tap(findTestObject('Maya/spy1/upd/android.widget.TextView0 - 6013 XXXX 565'), 0)
...
def otpMessage = Mobile.getText(findTestObject('Maya/spy1/android.widget.TextView0 - Your OTP no. is 912629'), 0)
...
Mobile.getText(findTestObject('Maya/spy1/upd/android.widget.TextView0 - 6013 XXXX 565'), 0)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.ImageView0 (1)'), 0)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.EditText0 - thgmail.com'), 0)

Mobile.setText(findTestObject('Maya/spy1/upd/android.widget.EditText0 - thhijgmail.com'), 'th', 0)
...
Mobile.setText(findTestObject('Maya/spy1/upd/android.widget.EditText0 - thhijgmail.com'), 'th@gmail.com', 0)
...
Mobile.tapAtPosition(700.5, 693.2, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tapAtPosition(141.3, 251.6)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.ImageView0 (3)'), 0)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.TextView0 - Take a photo'), 0)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.ImageView0 (5)'), 0)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.ImageView0 (3)'), 0)

not_run: Mobile.tap(findTestObject('Maya/update Profile/android.widget.TextView0 - Cancel'), 0)
...
not_run: Mobile.setText(findTestObject('Maya/update Profile/android.widget.EditText0 - th'), 'thhij@gmail.com', 0)
