...
not_run: Mobile.verifyElementExist(findTestObject('Maya/spy1/android.widget.TextView0 - 17180841120M'), 0, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.getText(findTestObject('Maya/spy1/android.widget.TextView0 - 11 Sep 2020 1108 AM'), 0, FailureHandling.CONTINUE_ON_FAILURE)
