...
Mobile.verifyElementExist(findTestObject('Maya/spy1/android.widget.TextView0 - View your expenses to roughly gauge how much to spend this week Test.'), 
    3)
...
Mobile.tapAtPosition(990.4, 194.1)
...
not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.ImageView0 (4)'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.ImageView0 (3)'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.ImageView0 (5)'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Add Now'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Set Category'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Entertainment'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Art  craft store'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Done'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - -RM  0.00'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - 2 (2)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - 3 (2)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.ImageView0 (7)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Add Expense'), 0)

not_run: Mobile.getText(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Latest'), 0)

not_run: Mobile.verifyElementExist(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Latest'), 0)

not_run: Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Onboarding\\Screen28.png', FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.getText(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Categories'), 0)

not_run: Mobile.verifyElementExist(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Categories'), 0)

not_run: Mobile.getText(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Merchants'), 0)

not_run: Mobile.verifyElementExist(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Merchants'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.view.ViewGroup0'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.ImageView0 (8)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.TextView0 - Yes'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/Onboarding Moments/android.widget.ImageView0 (14)'), 0)
