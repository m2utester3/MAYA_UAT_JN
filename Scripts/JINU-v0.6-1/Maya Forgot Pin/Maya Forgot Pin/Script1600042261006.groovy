...
not_run: Mobile.tap(findTestObject('Maya/Forgot Pin/android.widget.ImageView0 (2)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Forgot Pin/android.widget.TextView0 - Hello'), 0)

not_run: Mobile.tap(findTestObject('Maya/Forgot Pin/android.widget.TextView0 - Forgot PIN'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/Forgot Pin/android.widget.ImageView0 (3)'), 0)
...
Mobile.tapAndHoldAtPosition(97, 186.6, 1)
...
not_run: Mobile.tap(findTestObject('Maya/Forgot Pin/android.widget.TextView0 - Call Now'), 0)

not_run: Mobile.tap(findTestObject('Maya/Forgot Pin/android.widget.Button0 - CANCEL'), 0)
