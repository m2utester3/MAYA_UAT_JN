...
'Launch the App'
Mobile.tap(findTestObject('Maya/spy1/android.widget.ImageView0'), 0)
...
//otp
not_run: Mobile.tap(findTestObject('Maya/spy1/android.widget.TextView0 - Your OTP no. is 912629'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/One Tap Authorisation/android.widget.ImageView0 (2)'), 0)
...
def otpMess = Mobile.getText(findTestObject('Maya/spy1/android.widget.TextView0 - Your OTP no. is 912629'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/One Tap Authorisation/android.widget.ImageView0 (6)'), 0)
...
def otp = Mobile.getText(findTestObject('Maya/spy1/android.widget.TextView0 - Your OTP no. is 912629'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/One Tap Authorisation/android.widget.ImageView0 (7)'), 0)
