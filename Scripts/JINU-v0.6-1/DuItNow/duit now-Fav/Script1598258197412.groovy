...
not_run: Mobile.tap(findTestObject('Maya/New_Transfer/android.widget.ImageView0-child'), 0)

Mobile.tapAtPosition(273.2, 1230.5)
...
Mobile.tapAtPosition(1008.2, 1395.5)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.tapAtPosition(646, 1670.5)
...
Mobile.tapAtPosition(359.2, 802.2)

not_run: Mobile.tap(findTestObject('Maya/duitNowFav/android.widget.TextView0 - Pbb'), 5)
...
not_run: Mobile.getText(findTestObject('Maya/duitNowFav/android.widget.TextView0 - 179860600M'), 0)

not_run: Mobile.verifyElementExist(findTestObject('Maya/duitNowFav/android.widget.TextView0 - 179860600M'), 0, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.getText(findTestObject('Maya/duitNowFav/android.widget.TextView0 - 16 Apr 2020 0819 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.verifyElementExist(findTestObject('Maya/duitNowFav/android.widget.TextView0 - 16 Apr 2020 0819 PM'), 0, 
...
not_run: Mobile.getText(findTestObject('Maya/New_Transfer/android.view.View0 - 17180008563M'), 0)

Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Third Party\\Screenshot24', FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.verifyElementExist(findTestObject('Maya/New_Transfer/android.view.View0 - 17180008563M'), 0)
...
not_run: Mobile.tapAndHoldAtPosition(627, 376, 2, FailureHandling.CONTINUE_ON_FAILURE)
