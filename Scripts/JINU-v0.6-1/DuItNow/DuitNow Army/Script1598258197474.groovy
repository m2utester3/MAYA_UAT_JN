...
not_run: Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.ImageView0 (8)'), 0)
...
not_run: Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 17180039560M'), 0)

not_run: Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 17180039560M'), 0)

not_run: Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 12 Jul 2020 513 PM'), 0)

not_run: Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 12 Jul 2020 513 PM'), 
    0)
...
not_run: Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - MC11111117180038208M'), 0)
...
not_run: Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 11 Jul 2020 0441 PM'), 0)
...
not_run: Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.ImageView0 (4)'), 0)

not_run: Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Share Receipt'), 0)

not_run: Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.swipe(831, 1382, 800, 100)
...
not_run: Mobile.getText(findTestObject('Maya/drop4 CR/android.view.View0 - 17180225875M'), 0)

not_run: Mobile.verifyElementExist(findTestObject('Maya/drop4 CR/android.view.View0 - 17180225875M'), 0)
