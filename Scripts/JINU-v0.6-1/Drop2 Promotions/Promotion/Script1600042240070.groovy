...
Mobile.tapAtPosition(966, 194.1)

Mobile.delay(5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.setText(findTestObject('Maya/Promotions/android.widget.EditText0 - Type to search (1)'), 'Coffee', 0)
...
Mobile.tapAtPosition(943.9, 391.3)
...
Mobile.tapAtPosition(844.2, 1277.8)
...
not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.ImageView0 (11)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.TextView0 - Apply Filter (1)'), 0)

not_run: Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Promotions\\Screenshot6', FailureHandling.STOP_ON_FAILURE)
...
Mobile.tapAtPosition(619, 1255.8)
...
not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Promotions\\Screenshot8', FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.ImageView0 (12)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.ImageView0 (20)'), 0)
...
not_run: Mobile.getText(findTestObject('Maya/Promotions/android.widget.TextView0 - Promo ends in (1)'), 0)

not_run: Mobile.getText(findTestObject('Maya/Promotions/android.widget.TextView0 - Redeem now (1)'), 0)

not_run: Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.swipe(592, 1887, 550, 500)

not_run: Mobile.getText(findTestObject('Maya/Promotions/android.widget.TextView0 - Terms  Conditions'), 0)

not_run: Mobile.tapAndHoldAtPosition(975, 177, 1)

not_run: Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.TextView0 - Share'), 0)

not_run: Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Promotions\\Screenshot9', FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.Button0 - Cancel'), 0)

not_run: Mobile.tapAndHoldAtPosition(975, 177, 1)

not_run: Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.TextView0 - Not Interested in This'), 0)

not_run: Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Promotions\\Screenshot19', FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.delay(5)

not_run: Mobile.swipe(592, 1887, 550, 500)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.TextView0 - Terms  Conditions'), 0)

not_run: Mobile.delay(10, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Promotions\\Screenshot11', FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.ImageView0 (15)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.TextView0 - Redeem now (1)'), 0)

not_run: Mobile.getText(findTestObject('Maya/Promotions/android.widget.TextView0 - Scan  Pay'), 0)

not_run: Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Promotions\\Screenshot12', FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.ImageView0 (18)'), 0)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.TextView0 - Save and Use Later'), 0)

not_run: Mobile.getText(findTestObject('Maya/Promotions/android.widget.TextView0 - Saved'), 0)

not_run: Mobile.tap(findTestObject('Maya/Promotions/android.widget.TextView0 - Saved (1)'), 0)

not_run: Mobile.getText(findTestObject('Maya/Promotions/android.widget.TextView0 - Save and Use Later (1)'), 0)

not_run: Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\Promotions\\Screenshot13', FailureHandling.STOP_ON_FAILURE)
