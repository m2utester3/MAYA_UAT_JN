...
Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Settings (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Maybank2u (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.setText(findTestObject('Maya/RegisterDuitNow/android.widget.EditText0'), 'pass1234', 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - NRIC Number (5)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - NRIC Number (5)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 5263'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 5263'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Maybank (4)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\DuitNowProxy\\Screen5.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Maybank (4)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - NRIC Number (5)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - NRIC Number (6)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - NRIC Number (6)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 5263 (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - 5263 (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Status (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Status (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Status (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Status (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - ACTIVE (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - ACTIVE (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Receiving bank (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Receiving bank (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Maybank (3)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\DuitNowProxy\\Screen6.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Receiving Account (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Continue (7)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Agree and Confirm (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Done (10)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\DuitNowProxy\\Screen75.png', FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\DuitNowProxy\\Screen56.png', FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Deregister DuitNow'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\DuitNowProxy\\Screen8.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Confirm (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
def otp = Mobile.getText(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - Your OTP no. is 850051'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Link your Maybank account to an ID for DuitNow (2)'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Link your Maybank account to an ID for DuitNow (2)'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Select account'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Not registered'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\DuitNowProxy\\Screen8.png', FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.view.ViewGroup0'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Disable Temporarily'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Confirm (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Confirm (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

def otpM = Mobile.getText(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - Your OTP no. is 850051'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - INACTIVE'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - INACTIVE'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Enable'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Confirm (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

def otpMi = Mobile.getText(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - Your OTP no. is 850051'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Notifications'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Third Party CA account/android.widget.TextView0 - Got It'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Today'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Today'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Notifications (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Notifications (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Notifications (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Maybank2u DuitNow ID Deregistration'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been deregistered.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been deregistered.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been registered.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been registered.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Maybank2u DuitNow ID Proxy disabled'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been disabled.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been disabled.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Maybank2u DuitNow ID Proxy enabled'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Maybank2u DuitNow ID Proxy enabled'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been enabled.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been enabled.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 613 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 613 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.swipe(682, 892, 715, 754, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/spy/android.widget.TextView0 - Duitnow Proxy (NRIC Number) ending 5263 has just been updated.'), 
    0, FailureHandling.CONTINUE_ON_FAILURE)
