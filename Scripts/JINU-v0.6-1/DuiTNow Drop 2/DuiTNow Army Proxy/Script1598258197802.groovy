...
Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - More'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Settings'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Maybank2u'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.setText(findTestObject('Maya/login again/android.widget.EditText0 (1)'), 'rpp12345', 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - More (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Settings (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Maybank2u (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - DuitNow (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - DuitNow (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - ID Number'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - 4178 (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Maybank'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - ID Number'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - 4178 (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - NRIC Number'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Status'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - ACTIVE (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Receiving bank'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tapAndHoldAtPosition(648, 1230.3, 1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Continue (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - NRIC Number (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - 4178 (3)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Agree and Confirm (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Confirm (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - NRIC Number (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Disable Temporarily (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Confirm (3)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - INACTIVE (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Enable'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Confirm (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Confirm (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Deregister DuitNow (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - ID Number (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Select account'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Army  Police ID'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Army  Police ID (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - More (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Notifications'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/Nric Proxy Army/android.widget.TextView0 - Maybank2u DuitNow ID Registration'), 0, FailureHandling.CONTINUE_ON_FAILURE)
