...
Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Maybank (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Maybank (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 1028'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 1028'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\LENOVO\\Screenshot\\DuitNowProxy\\Screen5.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number (1)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Maybank (3)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 1028'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 1028'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 1914'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/spy1/proxy/android.widget.TextView0 - 1914'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number (2)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tapAtPosition(642.7, 730.2, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number (3)'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/RegisterDuitNow/android.widget.TextView0 - Mobile Number (3)'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1151 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1151 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1152 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1152 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1153 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1153 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1154 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1154 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1155 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - 1155 PM'), 0, FailureHandling.CONTINUE_ON_FAILURE)
