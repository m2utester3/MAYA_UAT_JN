...
<WebElementEntity>
   ...
   <name>android.widget.Button0-Maybank2u</name>
   <tag></tag>
   <elementGuidId>f717027b-10db-45de-ace1-da27cd1e0dcd</elementGuidId>
   <selectorCollection>
      <entry>
         <key>BASIC</key>
         <value>//*[@class = 'android.widget.Button' and (contains(text(), 'bank') or contains(., 'bank'))]</value>
      </entry>
   </selectorCollection>
